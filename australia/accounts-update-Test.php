      ...
      <td valign="top"><fieldset>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="4">
          <tr>
            ...
            <input type="text" name="firstName" id="firstName" title="Enter Name" value="<?=$rowSearch['Name'];?>" /></td>
            <td width="13%" align="left" valign="middle" bgcolor="#F2F2F2">LastName</td>
            <td width="23%" align="left" valign="middle" bgcolor="#F2F2F2">
                <input type="text" name="lastName" id="lastName"  title="Enter Last Name" value="<?=$rowSearch['Last_Name'];?>" /></td>
            <td width="11%" align="left" valign="middle" bgcolor="#F2F2F2">Mobile</td>
            <td width="20%" align="left" valign="middle" bgcolor="#F2F2F2">
                <input type="text" name="mobilePhone" id="mobilePhone"  title="Enter Mobile Phone" value="<?=$rowSearch['Mobile'];?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#DFEBF4">Email Address</td>
            <td align="left" valign="middle" bgcolor="#DFEBF4">
                <input type="text" name="emailAddress" id="emailAddress"  title="Enter Email Address" value="<?=$rowSearch['Email'];?>" /></td>
            <td align="left" valign="middle" bgcolor="#DFEBF4">Passport No.</td>
            <td align="left" valign="middle" bgcolor="#DFEBF4">
            <input type="text" name="passportNo" id="passportNo"  title="Enter Passport Number" value="<?=$rowSearch['Passport'];?>" />
            </td>
            <td align="left" valign="middle" bgcolor="#DFEBF4">Visa Expiry Date</td>
            <td align="left" valign="middle" bgcolor="#DFEBF4">
            <input type="text" name="visaExpDate" id="visaExpDate" class="datePicker" title="yyyy-mm-dd" value="<?=$rowSearch['visaExpDate'];?>" />
            </td>
            </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#F2F2F2">Enrolment Date</td>
            <td align="left" valign="middle" bgcolor="#F2F2F2">
                <input type="text" name="enrolmentDate" id="enrolmentDate" class="datePicker" title="yyyy-mm-dd" value="<?=$rowSearch['Enrolment_Date'];?>"/>
            </td>
            <td align="left" valign="middle" bgcolor="#F2F2F2">Course Length (Weeks)</td>
            <td align="left" valign="middle" bgcolor="#F2F2F2">
                <input type="text" name="courseLenght" id="courseLenght"  title="Course Lenght" value="<?=$rowSearch['Course_Lenght_in_Weeks'];?>" /></td>
            <td align="left" valign="middle" bgcolor="#F2F2F2">Total Course Cost ($)</td>
            <td align="left" valign="middle" bgcolor="#F2F2F2">
                <input type="text" name="totalCourseCost" id="totalCourseCost"  title="Total Course Cost ($)"  value="<?=$rowSearch['Total_Course_Cost'];?>" /></td>
          </tr>
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#DFEBF4">
            <input type="text" name="courseName" id="courseName"  title="Enter Course Name" value="<?=$rowSearch['Course_Name'];?>"/>
            </td>
...
<tr>
   ...
   <table width="100%" border="0" cellspacing="1" cellpadding="4">
   	<tr>
        ...
        <td align="left" valign="middle" bgcolor="#F2F2F2">
	        <input type="hidden" name="invNumber[]" value="<?=$invoiceRes['invoice_Id'];?>" />
            <input type="text" id=" " class="field" name="payments[]" value="<?=$invoiceRes['paymentFee'];?>" />
        </td>
        <td align="left" valign="middle" bgcolor="#F2F2F2">
        	<label>Commission $</label>
        </td>
        <td align="left" valign="middle" bgcolor="#F2F2F2">
        	<input type="text" class="field" name="realPayment[]" value="<?=$invoiceRes['commissionValue'];?>" />
        </td>
        <td align="left" valign="middle" bgcolor="#F2F2F2">
        	<label>GST(10%)</label>
        </td>
        <td align="left" valign="middle" bgcolor="#F2F2F2">
        	<input type="text" style="width:65px;" class="field" name="GSTexc[]" value="<?=$invoiceRes['GSTexc'];?>" />
        </td>
    </tr>
    <tr>
    	<td align="left" valign="middle" bgcolor="#DFEBF4">
        ...
        <td align="left" valign="middle" bgcolor="#DFEBF4">
        	<input type="text" class="field" name="GSTinc[]" value="<?=$invoiceRes['GSTinc'];?>" />
        </td>
        <td align="left" valign="middle" bgcolor="#DFEBF4">
        	<label>Invoice No.</label>
        </td>
        <td align="left" valign="middle" bgcolor="#DFEBF4">
        	<input type="text" class="field" name="InvoiceNumber[]"  value="<?=$invoiceRes['invoiceNumber'];?>"/>
        </td>
        <td align="left" valign="middle" bgcolor="#DFEBF4">
        	<label>Comm. Deducted Upfront</label>
        </td>
        <td align="left" valign="middle" bgcolor="#DFEBF4">
        	<input name="CommDeducted[]" type="checkbox" class="pay" style="width:15px;"  <?php if ($invoiceRes['CommDeducted'] == 'Y'){ echo "checked"; }?> />
        </td>
    </tr>
    <tr>
    	<td align="left" valign="middle" bgcolor="#F2F2F2">
        ...
        <td align="left" valign="middle" bgcolor="#F2F2F2">
        	<input type="text" name="PaymentDateDue[]" class="datePicker field" title="yyyy-mm-dd"  value="<?=$invoiceRes['payDueDate'];?>" />
        </td>
        <td align="left" valign="middle" bgcolor="#F2F2F2">
        	<label>Student Paid Date</label>
        </td>
        <td align="left" valign="middle" bgcolor="#F2F2F2">
        	<input type="text" name="StudentPaidDate[]" class="datePicker field" title="yyyy-mm-dd" value="<?=$invoiceRes['StudentPaidDate'];?>" />
        </td>
        <td align="left" valign="middle" bgcolor="#F2F2F2">
        	<label>Student Total($) Paid</label></td>
        <td align="left" valign="middle" bgcolor="#F2F2F2">
        	<input type="text" name="TotalPaid[]" class="field" value="<?=$invoiceRes['totalPaid'];?>"  />
        </td>
    </tr>
    <tr>
    	<td align="left" valign="middle" bgcolor="#DFEBF4">
        ...
        <td align="left" valign="middle" bgcolor="#DFEBF4">
        	<input type="text" name="ColPaymentDateDue[]" class="datePicker field" title="yyyy-mm-dd" value="<?=$invoiceRes['ColPaymentDateDue'];?>"  />
        </td>
        <td align="left" valign="middle" bgcolor="#DFEBF4">
        	<label>College Date Paid</label>
        </td>
        <td align="left" valign="middle" bgcolor="#DFEBF4">
        	<input type="text" name="CollegeDatePaid[]" class="datePicker field" title="yyyy-mm-dd" value="<?=$invoiceRes['colPaidDate'];?>" />
        </td>
        <td align="left" valign="middle" bgcolor="#DFEBF4"><label>College Total($) Paid</label></td>
        <td align="left" valign="middle" bgcolor="#DFEBF4">
        	<input type="text" name="ColTotalPaid[]" class="field"  value="<?=$invoiceRes['ColTotalPaid'];?>" /></td></tr>
    <tr>
        <td bgcolor="#F2F2F2">
        	<label style="float:right;">Marketing Incentive </label></td>
        <td align="left" valign="middle" bgcolor="#F2F2F2">
         <input name="marketingIncentive[]" type="checkbox" class="pay" style="width:15px;"  <?php if ($invoiceRes['marketingIncentive'] == 'Y'){ echo "checked"; }?> />
        </td>
        <td bgcolor="#F2F2F2">
                <input name="mkIncentiveValue[]" type="text" class=" field" id="mkIncentive-<?=$invoiceRes['invoice_Id'];?>" value="<?=$invoiceRes['mkIncentiveValue'];?>"  />
        </td>
        <td bgcolor="#F2F2F2">&nbsp;</td>
        <td bgcolor="#F2F2F2">
        	<label style="float:right;">Generate Invoice >> </label></td>
        <td bgcolor="#F2F2F2">
        	<a href="#" onclick="callAlert();" title="" style="font-size:.8em;">Click to Generate the Invoice</a>
                <script type="text/javascript">
                function callAlert(){
                    alert('Sorry!! \nThis link has been temporarily disabled...\n\nOnce updated the content, it will be available again.');
                }
                </script>
        </td>
    </tr>
   ...
   <!-- -->
      ...
      <td align="left" valign="top"><fieldset>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="4">
          <tr>
            ...
            <td bgcolor="#DFEBF4"><input type="text" name="numberFeesPaid" id="numberFeesPaid"  title="Number of Fees Paid" /></td>
    ...
    <tr class="hidden">
      <td height="40" align="left" valign="top">
        <div align="center">
            <input type="button" name="goBack" id="goBack" value="< Back to Search"  onclick="window.location='accounts-update-Test.php';" />
