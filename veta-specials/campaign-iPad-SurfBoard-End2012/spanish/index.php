  ...
  <table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="borde">
    <tr>
      <td valign="top"><table width="980" cellspacing="10">
        <tr>
          <td width="465" align="center" valign="top" bgcolor="#0073B4"><img src="images/IPAD-SURF-home.jpg" width="465" height="680" /><br>
            <br>
            <br>            <a href="http://www.australiaveta.com.au/espanol/viva-estudie-y-trabaje-en-australia.php" target="_blank" class="linkweb">www.australiaveta.com.au</a><br>            <br></td>
          <td width="479" valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tr>
              <td height="100" valign="top" bgcolor="#CC0001"><h2>Ingresa tus datos y estaremos en contacto contigo lo antes posible para hablar de tus opciones. <br />
                <br />
              </h2>
                <h2>También tendrás acceso a la lista de trabajo calificado, no calificado y acomodación en Australia.</h2></td>
            </tr>
            <tr>
              <td align="center" valign="top"><table width="100%">
                ...
                <tr>
                  <td align="left" valign="middle">Occupation Name</td>
                ...
                <tr>
                  <td colspan="2" align="left" valign="middle">
                    ...
                    Yo he leido y acepto los <a href="terms-and-conditions.html" class="blue">Terminos &amp; Condiciones</a><span class="rojo">*</span></td>
                  </tr>
                <tr>
                  <td colspan="2" align="left" valign="middle">
