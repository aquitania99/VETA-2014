...
<form id="updateClient" name="updateClient" method="post" action="<?=$_SERVER['PHP_SELF'];?>">
  ...
  <table width="900" border="0" align="center" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF" class="bordes">
      ...
      <td valign="top"><fieldset>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="4">
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F2F2F2"><input disabled="disabled" disabled="disabled" type="text" name="firstName" id="firstName" value="<?=$rowSearch['firstName'];?>" /></td>
            <td align="left" valign="middle" bgcolor="#F2F2F2">LastName</td>
            <td align="left" valign="middle" bgcolor="#F2F2F2"><input disabled="disabled" type="text" name="lastName" id="lastName" value="<?=$rowSearch['lastName'];?>" /></td>
            <td align="left" valign="middle" bgcolor="#F2F2F2">Mobile</td>
            <td align="left" valign="middle" bgcolor="#F2F2F2"><input disabled="disabled" type="text" name="mobilePhone" id="mobilePhone" value="<?=$rowSearch['mobilePhone'];?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#DFEBF4">Email Address</td>
            <td align="left" valign="middle" bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="emailAddress" id="emailAddress" value="<?=$rowSearch['emailAddress'];?>" /></td>
            <td align="left" valign="middle" bgcolor="#DFEBF4">Visa ExpDate</td>
            <td align="left" valign="middle" bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="visaExpDate" id="visaExpDate" value="<?=$rowSearch['visaExpDate'];?>" /></td>
          ...
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F2F2F2"><input disabled="disabled" type="text" name="originCountry" id="originCountry"  value="<?=$rowSearch['originCountry'];?>" /></td>
            <td align="left" valign="middle" bgcolor="#F2F2F2">Residency Country</td>
            <td align="left" valign="middle" bgcolor="#F2F2F2"><input disabled="disabled" type="text" name="residencyCountry" id="residencyCountry" value="<?=$rowSearch['residencyCountry'];?>" /></td>
            <td align="left" valign="middle" bgcolor="#F2F2F2">Nationality</td>
            <td align="left" valign="middle" bgcolor="#F2F2F2"><input disabled="disabled" type="text" name="nationality" id="nationality" value="<?=$rowSearch['nacionality'];?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#DFEBF4">Passport Number</td>
            <td align="left" valign="middle" bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="passNumber" id="passNumber" value="<?=$rowSearch['passNumber'];?>" /></td>
            <td align="left" valign="middle" bgcolor="#DFEBF4">Passport Expiry Date</td>
            <td align="left" valign="middle" bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="passExpDate" id="passExpDate" value="<?=$rowSearch['passExpDate'];?>" /></td>
            <td align="left" valign="middle" bgcolor="#DFEBF4">Date Of Birth</td>
            <td align="left" valign="middle" bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="DOB" id="DOB" value="<?=$rowSearch['DOB'];?>" /></td>
          </tr>
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F2F2F2"><input disabled="disabled" type="text" name="skype" id="skype" value="<?=$rowSearch['skype'];?>" /></td>
            <td align="left" valign="middle" bgcolor="#F2F2F2">Msn</td>
            <td align="left" valign="middle" bgcolor="#F2F2F2"><input disabled="disabled" type="text" name="msn" id="msn" value="<?=$rowSearch['msn'];?>" /></td>
          </tr>
        </table>
      </fieldset></td>
    </tr>
      ...
      <td align="left" valign="top"><fieldset>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="4">
          <tr>
            ...
            <td bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="profession" id="profession" value="<?=$rowSearch['profession'];?>" /></td>
            <td bgcolor="#DFEBF4">Work Experience</td>
            <td bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="workExperience" id="workExperience" value="<?=$rowSearch['workExperience'];?>" /></td>
            <td bgcolor="#DFEBF4">College Name</td>
            <td bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="collegeName" id="collegeName" value="<?=$rowSearch['collegeName'];?>" /></td>
          </tr>
          <tr>
            <td bgcolor="#F2F2F2">Degree Date</td>
            <td bgcolor="#F2F2F2"><input disabled="disabled" type="text" name="degreeDate" id="degreeDate" value="<?=$rowSearch['degreeDate'];?>" /></td>
            <td bgcolor="#F2F2F2">Degree Uni</td>
            <td bgcolor="#F2F2F2"><input disabled="disabled" type="text" name="degreeUni" id="degreeUni" value="<?=$rowSearch['degreeUni'];?>" /></td>
            <td bgcolor="#F2F2F2">Home Phone</td>
            <td colspan="3" bgcolor="#F2F2F2"><input disabled="disabled" type="text" name="homePhone" id="homePhone" value="<?=$rowSearch['homePhone'];?>" /></td>
          </tr>
          <tr>
            <td bgcolor="#DFEBF4">Seminar Attendance</td>
            <td bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="seminarAttendance" id="seminarAttendance" value="<?=$rowSearch['seminarAttendance'];?>" /></td>
            <td bgcolor="#DFEBF4">Seminar Date</td>
            <td bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="seminarDate" id="seminarDate" value="<?=$rowSearch['seminarDate'];?>" /></td>
      ...
      <td align="left" valign="top"><fieldset>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="4">
          ...
          <tr>
            ...
            <td bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="engTestDate" id="engTestDate" value="<?=$rowSearch['engTestDate'];?>" /></td>
            <td bgcolor="#DFEBF4">Overall Score</td>
            <td bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="overallScore" id="overallScore" value="<?=$rowSearch['overallScore'];?>" /></td>
            <td bgcolor="#DFEBF4">Report Form Number</td>
            <td bgcolor="#DFEBF4"><input disabled="disabled" type="text" class="auto-hint" title="Test Report Form Number" name="reptFormNo" id="reptFormNo" value="<?=$rowSearch['reportFormNo'];?>"  /></td>
          </tr>
        </table>
      </fieldset></td>
    </tr>
    <tr>
      <td align="left" valign="top"><fieldset>
        <legend>Cuarta Parte</legend>
        <table width="100%" border="0" cellspacing="1" cellpadding="4">
          <tr>
            <td bgcolor="#F2F2F2">General Comments</td>
            <td colspan="3" bgcolor="#F2F2F2"><textarea disabled="disabled" name="genComments" id="genComments" cols="90" rows="2"> <?=$rowSearch['genComments'];?></textarea></td>
          </tr>
          <tr>
            <td bgcolor="#DFEBF4">Modified By</td>
            <td bgcolor="#DFEBF4"><?=$_SESSION['login'];?><input disabled="disabled" type="hidden" name="<?php echo $_SESSION['login'];?>" id="textfield29" /></td>
            <td bgcolor="#DFEBF4">Modified on</td>
            <td bgcolor="#DFEBF4"><?=date('l jS \of F Y h:i:s A');?><input disabled="disabled" type="hidden" name="<?php echo date('l jS \of F Y h:i:s A');?>" id="textfield31" /></td>
          </tr>
        </table>
      </fieldset></td>
    </tr>
    <tr>
      <td height="40" align="left" valign="top"><div align="center">
          ...
          <input type="button" name="Print" id="print" value="Print this Record" onclick="javascript:window.print();" />
      </div></td>
    </tr>
  </table>
</form>
