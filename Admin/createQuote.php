...
$bond = $_POST['bond'];
$totalInstOne = $_POST['totalInstOne'];
//
...
$totalCourseFees2 = $courseInstalment2 + $courseEnrolmentFee2 + $materialsCost2 + $instalmentFee2;
...
$totalCourseFees3 = $courseInstalment3 + $courseEnrolmentFee3 + $materialsCost3 + $instalmentFee3;
...
$totalCourseFees4 = $courseInstalment4 + $courseEnrolmentFee4 + $materialsCost4 + $instalmentFee4;

//
$totalStudyWeeks = $_POST['totalStudyWeeks'];
$totalInstalmentsVal = $_POST['totalInstalmentsVal'];
$totalCoursesFee = $_POST['totalCoursesFee'];
//
      ...
      <tr>
        <td align="left" valign="top" bgcolor="#CCCCCC"><table width="910" border="0" cellpadding="2" cellspacing="1">
          <tr style="line-height:5px;">
            <td width="180" align="center" valign="middle" bgcolor="#CC0000"><span style="color:#fff"><strong>QUOTATION</strong></span></td>
            <td width="719" align="center" valign="middle" bgcolor="#CC0000"><span style="color:#fff"><strong>' . $quoteTitle . '</strong></span></td>
            </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#1F497D" class="tex-white"><span style="color:#fff">College Name:</span></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF" class="tex">' . $college . ' / ' . $college2 . ' / ' . $college3 . ' / ' . $college4 . '</td>
            </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#1F497D" class="tex-white"><span style="color:#fff">Course:</span></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF" class="tex">' . $courseName . ' / ' . $courseName2 . ' / ' . $courseName3 . ' / ' . $courseName4 . '</td>
            </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#1F497D" class="tex-white"><span style="color:#fff">New Course Start Date:</span></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF" class="tex">' . $newCourseStartDate . ' / ' . $newCourseStartDate2 . ' / ' . $newCourseStartDate3 . ' / ' . $newCourseStartDate4 . ' </td>
            </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#1F497D" class="tex-white"><span style="color:#fff">Course End Date:</span></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF" class="tex">' . $newCourseEndDate . ' / ' . $newCourseEndDate2 . ' / ' . $newCourseEndDate3 . ' / ' . $newCourseEndDate4 . '</td>
            </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#1F497D" class="tex-white"><span style="color:#fff">Holidays in Weeks:</span></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF" class="tex">' . $holidaysDuration . ' / ' . $holidaysDuration2 . ' / ' . $holidaysDuration3 . ' / ' . $holidaysDuration4 . '</td>
            </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#1F497D" class="tex-white"><span style="color:#fff">Time Table:</span></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF" class="tex">' . $courseTimeTable . ' / ' . $courseTimeTable2 . ' / ' . $courseTimeTable3 . ' / ' . $courseTimeTable4 . '</td>
            </tr>
          <tr>
          ...
          <tr>
            <td align="left" valign="middle" bgcolor="#1F497D" class="tex-white"><span style="color:#fff">Total Duration:</span></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF" class="tex">' . $courseDuration . '</td>
            </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#999999" class="tex-white"><strong><span style="color:#fff">Sub Total Course:</span></strong></td>
            <td align="center" valign="middle" bgcolor="#999999" class="tex"><strong><span style="color:#fff">' . $instOne . '</span></strong></td>
            </tr>
          <tr>
          ...
          <tr class="tex-white">
            ...
            <td align="center" valign="middle" bgcolor="#999999"><span style="color:#fff"><strong>' . $totalInstOne . '</strong></span></td>
            </tr>
          <tr>
            <td align="left" valign="middle" bgcolor="#990000" class="tex-white"><span style="color:#fff"><strong>1st Instalment:</strong></span></td>
          ...
          <tr class="tex-white">
            <td align="left" valign="middle" bgcolor="#990000"><span style="color:#fff"><strong>2st Instalment:</strong></span></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF"><strong>' . $totalCourseFees2 . '</strong></td>
            </tr>
          <tr class="tex-white">
            <td align="left" valign="middle" bgcolor="#990000"><span style="color:#fff"><strong>3st Instalment:</strong></span></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF"><strong>' . $totalCourseFees3 . '</strong></td>
            </tr>
          <tr class="tex-white">
            <td align="left" valign="middle" bgcolor="#990000"><span style="color:#fff"><strong>4st Instalment:</strong></span></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF"><strong>' . $totalCourseFees4 . '</strong></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td align="left" valign="top" bgcolor="#CCCCCC"><table width="910" border="0" cellpadding="2" cellspacing="1">
          ...
          <tr>
            <td align="left" valign="middle" bgcolor="#999999" class="tex-white"><h4><strong><span style="color:#fff">Total Fees AU$</span></strong></h4></td>
