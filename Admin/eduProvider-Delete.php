...
if (isset($deleteButton)) {
	//////////////////////////////////
	$schoolUpdate = $db->dbQuery("DELETE FROM `education_provider` WHERE edu_providerID = $id");
	//$resUpdateSchool = $db->fetch_array($schoolUpdate);
	//////////////////////////////////
	echo "<script type='text/javascript'>alert('The Record has been deleted from the DB!\n');</script>";
							...
							do {
								...
								<tr style="background-color:<?php echo $tr; ?>">
									<td align="left" valign="middle">
										<p style="text-align:left; margin:5px;">
											<input name="entityName" type="text" id="entityName" style="width:250px;"
									...
									<td align="center" valign="middle">
										...
										<p style="text-align:left; margin-left:5px; display:block; float:left;">
											<input name="location" type="text" id="location" style="width:330px;"
									...
									<td align="center" valign="middle">
										<p style="text-align:left; margin:5px; display:block; width:150px; float:left;">
											<input name="phone" type="text" id="phone"
											       value="<?php echo $resSchoolCheck['phone']; ?>" readonly/>
										</p>
									</td>
									<td>
										<p style="text-align:left; margin:5px; display:block;">
											...
											<input name="delete" type="submit" style="cursor:pointer;" value="Delete">
										</p>
									</td>
								</tr>
