<div class="one">
<fieldset>
<legend>Diploma Term No.1</legend>
	...
	<table width="100%" border="0" cellpadding="4" cellspacing="1" class="table table-bordered">
			...
			<td height="0" colspan="2" align="left" valign="middle" bgcolor="#DFEBF4">
				<?php if ($result['courseEntry'] == 1 && $result['amount_paid']) { ?>
					<div class="input-group"><span class="add-on"><strong>Receipt
								Number:</strong> <?php //echo $result['receipt']; ?></span>
			...
			<td height="0" align="left" valign="middle" bgcolor="#DFEBF4">
				<div class="input-group">
					<span class="add-on"><strong>Payment
							Fees:</strong> <?php echo $paymentResult['paymentTitle']; ?></span>
					<!-- <input name="quoteTitle" type="text" class="span9" id="prependedInput" placeholder="What are the Courses on this Quote..." maxlength="100"> -->
				</div>
			</td>
		</tr>
		<tr>
			...
			<td height="0" align="left" valign="middle" bgcolor="#F2F2F2"><strong>College Name</strong><br/>
				<?php echo $paymentResultColleges['entity_name']; ?>
				<input type="hidden" id="college" name="college" value='<?php echo $paymentResultColleges['entity_name']; ?>' />
			</td>
		...
		<tr>
			<td width="0" height="0" bgcolor="#DFEBF4">
				<strong>New Course Start Date</strong>
				<br>
			...
			<td height="0" bgcolor="#DFEBF4">
				<strong>New Course End Date </strong>
				<br>
				<?php echo $paymentResult['newCourseEndDate']; ?>
			</td>
			<td height="0" bgcolor="#DFEBF4">
				<strong>Holidays Duration (Terms)</strong>
				<br>
		...
		<tr>
			...
			<td height="0" bgcolor="#F2F2F2">
				<strong>Number of Instalments</strong>
				<br>
		...
		<tr>
			...
			<td height="0" bgcolor="#DFEBF4">
				<strong>Materials (AU$)</strong>
				<br>
				<strong>$</strong><?php echo $paymentResult['materialsCost']; ?>
			</td>
			<td height="0" bgcolor="#DFEBF4">
				<strong>Instalment Fee</strong>
				<br>
		...
		<tr>
			<td width="0" height="0" bgcolor="#F2F2F2">
				<strong class="style5">Instalment No. <span class="badge badge-important">1</span></strong>
				<br>
				<strong class="style5">$</strong><?php echo $paymentResult['instalment']; ?>
			</td>
			<td width="0" height="0" bgcolor="#F2F2F2">
				<strong class="style5">Total Instalment No. <span class="badge badge-important">1</span></strong>
				<br>
				<strong class="style5">$</strong><?php echo $paymentResult['totalInstalment']; ?>
			</td>
			<td width="0" height="0" bgcolor="#F2F2F2">
				<!-- DUE DATE BEGIN -->
...
<table width="100%" class="table table-bordered">
	...
	<tr>
		...
		<td align="left" valign="middle" bgcolor="#CCCCCC" class="span2"><strong class="style5">Total Amount Due
				$</strong> <?php echo $paymentResult['totalAmountDue'];//$totalDue; ?>
			<?php if (empty($result['amount_outstanding'])){ ?>
			<input type="hidden" name="totalAmount" id="totalAmount" value="<?php echo $paymentResult['totalAmountDue']; ?>"/></td>
		<?php
		}
		else {
			?>
