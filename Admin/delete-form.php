		...
		<tr>
			<td valign="top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td align="center" valign="middle"><h2>DELETE CLIENT</h2></td>
					</tr>
				</table>
			</td>
		</tr>
				...
				<fieldset>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="4">
						...
						<tr>
							...
							<td bgcolor="#DFEBF4"><input disabled="disabled" type="text" name="seminarAttendance"
							                             id="seminarAttendance"
							                             value="<?= $rowSearch['seminarAttendance']; ?>"/></td>
				...
				<td valign="top">
					...
					if (isset($existArray)) {
						...
						do {
							...
							echo "<a style='font-size:.95em; padding-bottom:.5em; color:#666 !important; cursor:pointer;' href='" . $_SERVER[PHP_SELF] . "?me=" . $rowSearch[0] . "' title=''>" . $i . ") " . $rowSearch[4] . " " . $rowSearch[5] . "</a><br />";
