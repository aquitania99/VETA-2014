...
////
		...
		$testing = 23;
		//
		$totalInstOne = ($result['weeklyCost'] * $result['courseDuration']) + $result['courseEnrolmentFee'] + $result['materialsCost'] + $result['instalmentFee'];
		$totalInstTwo = ($result['weeklyCost2'] * $result['courseDuration2']) + $result['courseEnrolmentFee2'] + $result['materialsCost2'] + $result['instalmentFee2'];
		$totalInstThree = ($result['weeklyCost3'] * $result['courseDuration3']) + $result['courseEnrolmentFee3'] + $result['materialsCost3'] + $result['instalmentFee3'];
		$totalInstFour = ($result['weeklyCost'] * $result['courseDuration4']) + $result['courseEnrolmentFee4'] + $result['materialsCost4'] + $result['instalmentFee4'];
		//
		...
		$searchColleges .= 'WHERE edu_providerID IN (' . $testing . ',' . $result['college2'] . ',' . $result['college3'] . ',' . $result['college4'] . ')';
...
//
	...
	<tr>
		<td>
			...
			<input type="hidden" name="totalInstOne" id="totalInstOne" value="<?php echo $totalInstOne; ?>"/>
			<!-- -->
	...
	<div name="quotation">
		<table width="100%" border="0" cellpadding="4" cellspacing="1" class="table table-hover">
			...
			<tr>
				<td width="0" height="0" bgcolor="#F2F2F2"><strong class="style5">Instalment No. 1</strong><br>
					<strong class="style5">$</strong><?php echo $result['instOne']; ?>
				</td>
				<td width="0" height="0" bgcolor="#F2F2F2"><strong class="style5">Total Instalment No. 1</strong><br>
		...
		<table width="100%" class="table table-condensed">
			<tr>
				<td align="left" valign="middle"><strong>Health Fund</strong><br>
					<?php echo $result['healthFund']; ?></td>
				<td align="left" valign="middle"><span class="add-on"><strong>Cost AU$</strong></span><br>
					<strong>$</strong><?php echo $result['mediBankCost']; ?></td>
				<td align="left" valign="middle">
					<div class="pull-left span2">
						<strong>Months</strong><br>
					<?php echo $result['mediBankMonths']; ?></td>
				<td align="left" valign="middle"><span class="add-on"><strong>Health Cover Type</strong></span><br>
					<?php echo $result['healthCoverType']; ?></td>
			</tr>
			<tr>
				<td align="left" valign="middle"><strong>Visas Fees AU$</strong><br>
					<strong>$</strong><?php echo $result['visaFees']; ?></td>
				<td align="left" valign="middle"><strong>Deposit</strong><br>
					<strong>$</strong><?php echo $result['deposit']; ?></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF"><strong>(-) Bond</strong><br>
					<strong>$</strong><?php echo $result['bond']; ?></td>
				<td align="left" valign="middle" bgcolor="#CCCCCC"><strong class="style5">Total Amount Due Instalment
						No.1<br>
						$</strong> <?php echo $totalDue; ?></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4" align="left" valign="middle"><strong>Notes</strong><br>
					...
					<div style="width:450px; height:120px; display:block;"> <?php echo $result['quoteNotes']; ?> </div>
				</td>
			</tr>
		</table>
	</div>
	...
	<?php if ($result['college2'] > 0) { ?>
		<div class="moreInstalments" id="moreInstalments2">
			<!-- -->
			<legend>English Course Instalment No. 2</legend>
			<table width="100%" border="0" cellpadding="4" cellspacing="1" class="table table-hover table-condensed">
				...
				<tr>
					...
					<td width="0" height="0" bgcolor="#DFEBF4"><strong class="style5">Total Instalment No.
							2</strong><br>
	...
	if ($result['college3'] > 0) { ?>
		<div class="moreInstalments" id="moreInstalments3">
			<!-- -->
			<legend> English Course Instalment No. 3</legend>
	...
	<select name="courseTimeTable2" class="span2 inst2" id="courseTimeTable2">
				...
				<tr>
					...
					<td width="0" height="0" bgcolor="#DFEBF4"><strong class="style5">Total Instalment No.
							3</strong><br>
						<strong class="style5">$</strong><?php echo $totalInstThree; ?></td>
					<td height="0" colspan="3" bgcolor="#DFEBF4">
	...
	if ($result['college4'] > 0) { ?>
		<div class="moreInstalments" id="moreInstalments4">
			<!-- -->
			<legend>English Course Instalment No. 4</legend>
			<table width="100%" border="0" cellpadding="4" cellspacing="1" class="table table-hover table-condensed">
				<tr>
					<td height="0" bgcolor="#DFEBF4"><strong>Course Name</strong><br>
	...
	<select name="courseTimeTable4" class="span2 inst2" id="courseTimeTable4">
				...
				<tr>
					...
					<td width="0" height="0" bgcolor="#DFEBF4"><strong class="style5">Total Instalment No.
							4</strong><br>
						<strong class="style5">$</strong><?php echo $totalInstFour; ?></td>
					<td height="0" colspan="3" bgcolor="#DFEBF4">
	...
	<tr>
		<td colspan="6">
			<div id="moreQuotes" name="moreQuotes">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td bgcolor="#CCCCCC"><strong class="style5">Total Study Weeks</strong><br>
							<strong class="style5"># </strong><?php echo $totalStudyWeeks; ?></td>
						<td bgcolor="#CCCCCC"><strong class="style5">Total Instalment(s)</strong><br>
							<strong class="style5">$</strong><?php echo $totalInstalmentsVal; ?></td>
						<td bgcolor="#CCCCCC"><strong class="style5">Total Course(s) Fee</strong><br>
							<strong class="style5">$</strong><?php echo $totalCoursesFee; ?></td>
					</tr>
				</table>
				<br>
		...
		<td colspan="6">
			<div class="form-actions pull-left">
				<a class="btn btn-warning btn-large"
				   href="quoteDiploma.php?eaddress=<?= $keyVal ?>&linkedTo=<?= $result['quoteNo']; ?>"><i
						class="icon-bullhorn"></i> ADD DIPLOMA...</a>
			</div>
