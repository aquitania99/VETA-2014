...
include('../inc/updateNewsletter.php');
/////////////////////////////////////////////////////
?>
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="1000" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#ffffff" class="bordes">
    ...
    <tr>
      ...
      <p>Title 1
        <input name="title8" type="text" id="title8" value="<?php echo $titleEight; ?>" size="60" />
      </p>
      <p>Text 1
        <textarea name="text1" id="text1" cols="60" rows="3"><?php echo $textOne; ?></textarea>
      </p>
      </fieldset></td>
    ...
    <tr>
      <td valign="top"><fieldset>
        ...
        <p>Title 2
          <input name="title3" type="text" id="title3" value="<?php echo $titleThree; ?>" size="60" />
          </p>
        Image 2 <?php echo $imageThree; ?><br />
        <p>Image 2
        ...
        <p>Text 3
          <textarea name="text3" cols="60" rows="3" wrap="virtual" id="text3"><?php echo $textThree; ?></textarea>
          </p>
      </fieldset></td>
    </tr>
    <tr>
      <td valign="top"><fieldset>
        ...
        <p>Image 3 <?php echo $imageFour; ?><br />
        </p>
        <p>Image 3
        ...
        <p>Title 3
          <input name="title4" type="text" id="title4" value="<?php echo $titleFour; ?>" size="60" />
        </p>
        <p>Text 3
          <textarea name="text4" cols="60" rows="3" wrap="virtual" id="text4"><?php echo $textFour; ?></textarea>
          </p>
      </fieldset></td>
    </tr>
    <tr>
      <td valign="top"><fieldset>
        ...
        <p>Image 4 <?php echo $imageFive; ?><br />      
        </p>
        <p>Image 4
        ...
        <p>Title 4
          <input name="title5" type="text" id="title5" value="<?php echo $titleFive; ?>" size="60" />
        </p>
        <p>Text 4
          <textarea name="text5" cols="60" rows="3" wrap="virtual" id="text5"><?php echo $textFive; ?></textarea>
          </p>
      </fieldset></td>
    </tr>
    <tr>
      <td valign="top"><fieldset>
        ...
        <p>Image 5 <?php echo $imageEight; ?><br />        
        </p>
        <p>Image 5
