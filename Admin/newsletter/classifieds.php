...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="1000" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF" class="bordes">
    <tr>
      <td colspan="3" valign="top"><table width="100%" border="0">
        ...
        <tr>
          ...
          <td width="0" align="right" valign="middle"><a href="#"><img src="images/boton1.png" width="155" height="50" border="0" /></a><a href="#"><img src="images/logout.png" width="134" height="50" border="0" /></a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      ...
      <td width="0" rowspan="4" valign="top"><fieldset>
        ...
        <h6><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','images/estructuraclasi1.png',1)"><img src="images/estructuraclasi.png" name="Image1" width="482" height="736" border="0" id="Image2" /></a></h6>
      </fieldset>      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="50" colspan="3" align="center" valign="middle"><img src="images/preview.jpg" width="204" height="64" /></td>
    </tr>
  </table>
</form>
</body>
