...
include('../inc/updateClassified.php');
/////////////////////////////////////////////////////
?>
  ...
  <table width="1000" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF" class="bordes">
    ...
    <tr>
      <td width="0" valign="top"><fieldset>
        ...
        <p>Text 1
          <textarea name="text1" id="text1" cols="45" rows="24"><?php echo $textOne; ?></textarea>
          </p>
      </fieldset></td>
      ...
      <p>Text 2
        <textarea name="text3" cols="45" rows="24" wrap="virtual" id="text3"><?php echo $textThree; ?></textarea>
      </p>
      </fieldset></td>
    ...
    <tr>
      ...
      <input name="submit" type="submit" class="boton" style="cursor:pointer;" id="submit" value="" /></td>
    </tr>
  </table>
</form>
</body>
