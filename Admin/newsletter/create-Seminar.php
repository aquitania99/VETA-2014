...
{
//////////////////////////////////////////////////////
include('../inc/insertSeminar.php');
/////////////////////////////////////////////////////
//echo "NewsletterID After Insert: ".$afterID."<br \>";
	if ($beforeID != $afterID){
		echo "<script>  
			window.location = 'previewSeminars.php?ID=$afterID';  
			</script>";
	}
	if ($beforeID == $afterID) { 	
			echo "Record not Inserted!!! Please Check the values entered.<br \><br \>";
			echo "<a href=".$_SERVER['PHP_SELF']."?task=1b>Try Again => Go back to create a Seminar Invitation</a><br \><br \>";
	} 
}
?>
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="1000" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF" class="bordes">
    ...
    <tr>
      ...
      <p>
        <textarea name="text1" cols="45" rows="20" wrap="virtual" id="text1"></textarea>
      </p>
      </fieldset></td>
      <td valign="top"><fieldset>
      <legend class="style5">English</legend>
      <p>
        <textarea name="text2" cols="45" rows="20"  id="text2"></textarea>
      </p>
      </fieldset></td>
    </tr>
    <!-- New Portuguese Text Added 24/04/2012 START -->
    <tr>
        <td valign="top">
            <fieldset>
                <legend class="style5">Portuguese</legend>
                <p>
                    <textarea name="text_br" cols="45" rows="20" wrap="virtual" id="text_br"></textarea>
                </p>
            </fieldset>
        </td>
        <td valign="top">
    ...
    <!-- New Portuguese Text Added 24/04/2012 END -->
    <tr>
      <td valign="top"><fieldset>
    ...
    <tr>
      ...
      <input name="submit" type="submit" class="boton" id="submit" style="cursor:pointer;" value="" /></td>
    </tr>
  </table>
</form>
</body>
