...
//DATE_FORMAT(DATE '%d/%m/%Y') as formatted_date
	$queryPrevious = $db->dbQuery("SELECT newsletterID as 'ID', title1 as 'title', creationDate as 'Date'  FROM newsletter ORDER BY Date DESC LIMIT 0, 10");
	...
	<table width="610" border="0" align="center" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF" class="bordes">
		...
		<tr>
			<td align="center" valign="middle"><h2><span
						title="Click for alternate translations">Newsletter Emails</span> <br/>
			...
			<tr>
				<td style="padding-left:18px;">
					<font style="color:mediumvioletred;">
						<a href="newsletter/previewNewsletter.php?ID=<?php echo $rowsPrevious['ID']; ?>"
