	...
	<table width="600" border="0" align="center" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF" class="bordes">
		<tr>
			<td>
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="211"><img src="newsletter/images/logomodulo.gif" width="194" height="106"
						                     align="absmiddle"/></td>
						<td><h2 align="center"><span id="result_box" lang="en" xml:lang="en"><span
										title="Click for alternate translations">online</span> <span
										title="Click for alternate translations">marketing</span></span> VETA</h2></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td align="center" valign="middle">
				...
				<input type="image" src="newsletter/images/login.jpg" width="204" height="64" border="0"
				       name="login-btn" id="login-btn"/>
			</td>
		</tr>
	</table>
</form>
