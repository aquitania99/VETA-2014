        ...
        <td valign='top' background='http://www.australiaveta.com.au/Admin/newsletter/images/fondo.jpg' style='background-repeat: no-repeat; background-position: center top;'><table width='810' border='0' cellspacing='0' cellpadding='0'>
          <tr>
            ...
            <td width='779' valign='top'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
              ...
              <tr>
                <td height='55' align='center' valign='middle'><h1 style='font-family: Arial, Helvetica, sans-serif; font-size: 26px; color: #DAE0F0; font-weight: bold; margin: 0px;'>Bienvenido / Welcome</h1></td>
              </tr>
              <tr>
                <td align='left' valign='top'><table width='775' border='0' cellspacing='6' cellpadding='0'>
                  <tr>
                    <td width='52' align='left' valign='top'>&nbsp;</td>
                    <td width='520' align='left' valign='top'><p align='center'><img src='http://www.australiaveta.com.au/Admin/newsletter/images/home6_esp.jpg' width='500' height='94' /></p>
                      <p>&nbsp;</p>
                      <p>Tus datos han sido recogidos recientemente, a traves de alguien de nuestro equipo, con el</p>
                      <p>fin de proveerte informacion sobre opciones de trabajo, lugares de acomodacion, aplicar</p>
                      <p>tax file number, inscripcion a cursos de RSA, Barista y white card. E informacion para la</p>
                      <p>renovacion de tu visa.</p>
                      <p>&nbsp;</p>
                      ...
                      <p>&nbsp;</p>
                      <p><strong>RECUERDA</strong> que si tu visa esta a punto de vencer, es importante que iniciemos el proceso de</p>
                      <p>renovacion con un mes de anticipacion.</p>
                      <p>&nbsp;</p>
                      <p align="center">&nbsp;</p>
                      <p>&nbsp;</p>
                      <p>&nbsp;</p>
                      ...
                      <tr>
                        <td align='left' valign='top'><img src='http://www.australiaveta.com.au/newsletter/images/foto3.gif' width='165' height='94' />
                          ...
                          <p align='center'>FOR FUTHER INFROMATION <br />
                            ...
                            T /9299 0203<br />
                            F + 02 9299 9214<br />
                             Info@mmmigration.com.au  <a style='font-size: 12px; color: #0099FF;' href='http://www.mmmigration.com.au' target='_blank'>www.mmmigration.com.au</a></p>                          </td>
                      </tr>
