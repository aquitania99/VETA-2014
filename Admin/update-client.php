...
if (session_is_registered('login')) {
	...
	<table width="600" border="0" align="center" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF" class="bordes">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td align="center" valign="middle"><h2><span
									title="Click for alternate translations">online</span> marketing VETA</h2></td>
					</tr>
				</table>
			</td>
		</tr>
		<tr>
			<td valign="middle">
				<fieldset>
					<legend>Update/Modify Client</legend>
					<?php
					if (isset($exist)) {
						?>
						<!-- /// /// -->
						<h3 style="margin-left:.2em;">Update - Contact Details</h3>
						<form id="babyStepsForm" name="form1" method="post" action="">
							<div style="display: block;" class="jQueryBabyStep" id="step1"><span id="name_error"
							                                                                     style="color: red;">You must enter your full name!</span>
							...
							Last Name: <input id="last_name" type="text" value="<?= $rowSearch['lastName']; ?>"/>
							<br/>
							Email Address: <input id="email" type="text" value="<?= $rowSearch['emailAddress']; ?>"/>
							<br/>
							Fecha de Nacimiento
							<br/>
							...
							<div style="display: none;" id="step3" class="hidden jQueryBabyStep">
								...
								<br/>
								Fecha de Vencimiento: (DD/MM/YYYY) <input type="text" name="visaExpDate"
								                                          id="visaExpDate"/>
								<br/>
								Numero de Pasaporte: <input type="text" name="passportNumber" id="passportNumber"/>
								<br/>
								Fecha de Vencimiento: (DD/MM/YYYY) <input type="text" name="passExpDate"
								                                          id="passExpDate"/>
								<br/>
							...
							<div style="display: none;" id="step4" class="hidden jQueryBabyStep">
								...
								Fecha en que se Presentó: (DD/MM/YYYY)<input type="text" name="engTestDate"
								                                             id="engTestDate"/>
								<br/>
								Puntaje Overall: <input type="text" name="engTestOverallScore"
								                        id="engTestOverallScore"/>
								<br/>
					...
					<?php
						...
						<form action="" method="post" id="search">
							<?php if (!isset($none) && !isset($exist)) { ?><label>Client Email </label><input
								type="text" name="searchEmail"/><input type="submit" name="search" value="search"/><br/>
							<?php
							}
							if (isset($none) && !isset($exist)) {
								?>
								<b>Advance Search....</b><br/>
								<label>Client First Name</label><input type="text" name="searchName"/><br/>
								<label>Client Last Name</label><input type="text" name="searchLastName"/><br/>
								<label>Client Passport</label><input type="text" name="searchPassport"/><br/>
