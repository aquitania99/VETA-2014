...
//
			...
			<table width="100%" border="0" cellpadding="4" cellspacing="1">
				<tr>
					...
					<td align="left" valign="middle" bgcolor="#DFEBF4">
						<?php echo "<strong>" . $counsellor->response['firstName'] . ' ' . $counsellor->response['lastName'] . "</strong>"; ?>
						<input type="text" style="visibility:hidden;" class="input-xlarge uneditable-input"
						       id="stCounsellor" value="<?php echo $cID; ?>"/>
					</td>
					<td align="left" valign="middle" bgcolor="#DFEBF4">&nbsp;</td>
		...
		<td valign="top">
			<fieldset>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="4" class="table table-hover">
					<tr>
						<td align="left" valign="middle" bgcolor="#F2F2F2">First Name<br> <input type="text"
						                                                                         name="firstName"
						                                                                         id="firstName"
						                                                                         class="auto-hint span2"
						                                                                         placeholder="Enter Name"/>
						</td>
						<td align="left" valign="middle" bgcolor="#F2F2F2">Last Name<br> <input type="text"
						                                                                        name="lastName"
						                                                                        id="lastName"
						                                                                        class="auto-hint span2"
						                                                                        placeholder="Enter Last Name"/>
						</td>
						<td align="left" valign="middle" bgcolor="#F2F2F2">Mobile<br> <input type="text"
						                                                                     name="mobilePhone"
						                                                                     id="mobilePhone"
						                                                                     class="span2"
					...
					<tr>
						<td align="left" valign="middle" bgcolor="#DFEBF4">Email Address<br> <input type="text"
						                                                                            name="emailAddress"
						                                                                            id="emailAddress"
						                                                                            class="auto-hint span2"
						                                                                            placeholder="Email Address"/>
						</td>
						<td align="left" valign="middle" bgcolor="#DFEBF4">Visa ExpDate<br> <input type="text"
						                                                                           name="visaExpDate"
						                                                                           id="visaExpDate"
						                                                                           class="datePicker auto-hint span2"
						...
						<td align="left" valign="middle" bgcolor="#DFEBF4">Visa Type<br>
							...
							<!-- <input type="text" name="visaType" id="visaType"  /> -->            </td>
					</tr>
					<tr>
						<td align="left" valign="middle" bgcolor="#F2F2F2">Origin Country<br> <input type="text"
						                                                                             name="originCountry"
						                                                                             id="originCountry"
						                                                                             class="span2"
						                                                                             placeholder="Origin Country"/>
						</td>
						<td align="left" valign="middle" bgcolor="#F2F2F2">Residency Country<br> <input type="text"
						                                                                                name="residencyCountry"
						                                                                                id="residencyCountry"
						                                                                                class="span2"
						                                                                                placeholder="Residency Country"/>
						</td>
						<td align="left" valign="middle" bgcolor="#F2F2F2">Nationality<br> <input type="text"
						                                                                          name="nationality"
						                                                                          id="nationality"
						                                                                          class="span2"
					...
					<tr>
						<td align="left" valign="middle" bgcolor="#DFEBF4">Passport Number<br> <input type="text"
						                                                                              name="passNumber"
						                                                                              id="passNumber"
						                                                                              class="span2"
						                                                                              placeholder="Passport Number"/>
						</td>
						<td align="left" valign="middle" bgcolor="#DFEBF4">Passport Expiry Date<br> <input type="text"
						                                                                                   name="passExpDate"
						                                                                                   id="passExpDate"
						                                                                                   class="datePicker auto-hint"
						                                                                                   placeholder='dd-mm-yyyy'/>
						</td>
						<td align="left" valign="middle" bgcolor="#DFEBF4">Date Of Birth<br> <input type="text"
						                                                                            name="DOB" id="DOB"
						                                                                            class="datePicker auto-hint"
						                                                                            placeholder='dd-mm-yyyy'/>
						</td>
					...
					<tr>
						...
						<td align="left" valign="middle" bgcolor="#F2F2F2">Skype<br> <input type="text" name="skype"
						                                                                    id="skype" class="span2"
						                                                                    placeholder="User Skype"/>
						</td>
						<td align="left" valign="middle" bgcolor="#F2F2F2">Home Phone<br> <input type="text"
						                                                                         name="homePhone"
						                                                                         id="homePhone"
						                                                                         class="span2"/></td>
					</tr>
	...
	<tr>
		<td align="left" valign="top">
			<fieldset>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="4" class="table table-hover">
					<tr>
						<td bgcolor="#DFEBF4">Profession<br> <input type="text" name="profession" id="profession"
						                                            class="span2"/></td>
						<td bgcolor="#DFEBF4">Work Experience<br> <input type="text" name="workExperience"
						                                                 id="workExperience" class="auto-hint span2"
						                                                 placeholder="Number of years of work experience"/>
						</td>
						<td bgcolor="#DFEBF4">University<br> <input type="text" name="collegeName" id="collegeName"
						                                            class="span2"/></td>
					</tr>
					<tr>
						<td bgcolor="#F2F2F2">Degree Date<br> <input type="text" name="degreeDate" id="degreeDate"
						                                             class="datePicker auto-hint span2"
						                                             placeholder='dd-mm-yyyy'/></td>
						<td bgcolor="#F2F2F2">Title<br> <input type="text" name="degreeUni" id="degreeUni"
						                                       class="span2"/></td>
						<td colspan="3" bgcolor="#F2F2F2"></td>
					</tr>
					<tr>
						<td bgcolor="#DFEBF4">Seminar Attendance<br>
							<input type="radio" value="1" name="seminarAttendance"/>YES &nbsp; <input type="radio"
							                                                                          value="0"
							                                                                          name="seminarAttendance"/>NO
						</td>
						<td bgcolor="#DFEBF4">Seminar Date<br> <input type="text" name="seminarDate" id="seminarDate"
						                                              class="datePicker auto-hint"
						                                              placeholder='dd-mm-yyyy'/></td>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="4" class="table table-hover">
					<tr>
						<td bgcolor="#F2F2F2">English Test<br>
							<input type="radio" value="1" name="engTest"/>
							YES &nbsp; <input type="radio" value="0" name="engTest"/>NO
						</td>
					...
					<tr>
						<td bgcolor="#DFEBF4">Eng. Test Date<br>
							<input type="text" name="engTestDate" id="engTestDate" class="datePicker auto-hint span2"
							       placeholder='dd-mm-yyyy'/>
						</td>
						...
						<td bgcolor="#DFEBF4">Report Form Number<br>
							<input type="text" class="auto-hint span2" placeholder="Test Report Form Number"
							       name="reptFormNo" id="reptFormNo"/>
						</td>
					</tr>
				</table>
			</fieldset>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="4">
					<tr>
						<td colspan="2" bgcolor="#DFEBF4">
							...
							<textarea name="genComments" id="genComments" class="span5" rows="4"></textarea></td>
					</tr>
					<tr>
	...
	<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		...
		<div class="modal-body">
			<p>Would you like to
				update <?php echo "<strong>" . $person->firstName . " " . $person->lastName . "</strong>"; ?></p>
		</div>
		<div class="modal-footer">
			<button class="btn" data-dismiss="modal" aria-hidden="true">No - Close</button>
			<button class="btn btn-primary" id="goAhead">Yes - Update</button>
		</div>
	</div>
	<!-- Modal End -->
		...
		$('#goAhead').click(function () {
			...
			$.ajax({
				...
				success: function (data) {
					...
					window.open('quotes.php?eaddress="$email"');
				}
			});
			//
			$('#myModal').modal('hide');
