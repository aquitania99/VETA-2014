...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><!-- InstanceBegin template="/Templates/templateseven.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title>Seven Studio - website design Sydney</title>
        <!-- InstanceEndEditable -->
...
<div id="navbar" class="fltrt">
                ...
                <div id="contactUs" class="fltlft">
					...
					<div id="contactBlurb">
                            ...
                            e-mail. <a href="mailto:info@sevenstudio.com.au" style="color:#444;">info@sevenstudio.com.au</a>
                            </b>
                        
						
					</div>
					<div id="contactForm" style="margin-top:80px">
                    <span><font class="titleportfolioname">Thank you for contacting us!</font><br /><br /><font class="font-size:1.1em;">Someone from our team will be in touch with you shortly.<br /><br /><b>Seven Studio -  Website Design</b></font></span>
                    </div>
                      <div id="locationMap">
          ...
          <!-- InstanceEndEditable --></div>      
            <div id="quoteGirl" onclick="window.location='http://www.sevenstudio.com.au/contact.php'"> </div>
                <!-- InstanceBeginEditable name="wel" --><div id="texdestacado">Welcome we are <strong>Seven Studio</strong>, an amazing crew, professional, reliable, very passionate about <strong>Web Design</strong>, <strong>Internet Development</strong>,<strong> e-marketing</strong> and <strong>Social Media</strong>.</div><!-- InstanceEndEditable -->
                <div id="boxmed">
            <div class="middleCol">
              <div class="midTitle">
