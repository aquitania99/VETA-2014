...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><!-- InstanceBegin template="/Templates/templateseven.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
		...
		<!-- InstanceBeginEditable name="stilo" -->
                <!-- Slide Show Start -->
        <script type="text/javascript" src="../7Studio/js/jquery.nivo.slider.pack.js"></script>
        <link rel="stylesheet" href="../7Studio/css/nivo-slider.css" type="text/css" media="screen" />
        <!-- Slide Show End -->
