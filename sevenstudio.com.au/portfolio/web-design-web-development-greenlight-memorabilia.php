...
<div id="navbar" class="fltrt">
                ...
                <div id="centerSection" class="curved"><!-- InstanceBeginEditable name="contenido" -->                    <div id="portframe" class="fltlft">
                      <div id="slider" class="nivoSlider">
                        <img src="../images/portfolio/Greenlight-Memorabilia/greenmemorabilia1.jpg" alt="graphic design - logo" />
					    <img src="../images/portfolio/Greenlight-Memorabilia/greenmemorabilia2.jpg" alt="Graphic Design Sydney South - Business Cards" />
                        <img src="../images/portfolio/Greenlight-Memorabilia/greenmemorabilia3.jpg" alt="Graphic Design Sydney South - Business Cards" /></div>
                    <script type="text/javascript">
                    ...
                    <div class="portfolioTitle">PORTFOLIO</div>
                      <div id="portfolioBlurb" style="height:520px">
                        <p class="titleportfolioname">
                          <b>Greenlight Memorabilia</b><br />
                  <ul>
