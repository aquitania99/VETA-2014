...
<div id="navbar" class="fltrt">
                ...
                <div id="centerSection" class="curved"><!-- InstanceBeginEditable name="contenido" -->                    <div id="portframe" class="fltlft">
                      <div id="slider" class="nivoSlider">
                        <img src="../images/portfolio/Greenlight-Pop-Culture/greenpopculture1.jpg" alt="graphic design - logo" />
					    <img src="../images/portfolio/Greenlight-Pop-Culture/greenpopculture2.jpg" alt="Graphic Design Sydney South - Business Cards" /></div>
                    <script type="text/javascript">
                  ...
                  <ul>
                                ...
                                <li>Landing page</li>
								<li>Twitter API implementation</li>
                                <li>Web Banner</li>
								<li>Shopping Cart</li>
								<li>Contact Form</li>
                            </ul>
