...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><!-- InstanceBegin template="/Templates/templateseven.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title>website design sydney south - graphic design</title>
        <!-- InstanceEndEditable -->
...
<div id="navbar" class="fltrt">
                ...
                <div id="centerSection" class="curved"><!-- InstanceBeginEditable name="contenido" -->                    <div id="portframe" class="fltlft">
                  ...
                  <img src="../images/portfolio/Advance-Property-Solutions/advance1.jpg" alt="website development" />
                  <img src="../images/portfolio/Advance-Property-Solutions/advance2.jpg" alt="website development" />
                  <img src="../images/portfolio/Advance-Property-Solutions/advance3.jpg" alt="graphic design - logo" />
                  <img src="../images/portfolio/Advance-Property-Solutions/advance4.jpg" alt="Graphic Design Sydney South - Business Cards" /></div>
                    <script type="text/javascript">
                    ...
                    <div class="portfolioTitle">PORTFOLIO</div>
                      <div id="portfolioBlurb">
                        <p class="titleportfolioname">
                            <b>Advance Property Solutions </b><br />
                        <ul>
                        ...
                        <div id="navigation">
						<div id="previous" onClick="window.location='website-and-graphic-design-sydney-estudienaustralia.php'"></div>
						<span class="back-to-portfolio"><a href="../portfolio.php" title="">Back to Portfolio</a></span>
						<div id="next" onClick="window.location='web-design-web-development-graphic-design-australia-veta.php'"></div>
				  </div>
                     </div>
                      <div id="portfoliolinkSM"> <span style="width: 80px; height:25px !important" class="fltlft">
                        <iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.sevenstudio.com.au%2Fportfolio%2Fwebsite-and-graphic-design-sydney-Advance-Property-Solutions.php&amp;send=false&amp;layout=button_count&amp;width=80&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=25" scrolling="No" frameborder="0" style="border:none; overflow:hidden; width:80px; height:25px;" allowtransparency="true"></iframe>
