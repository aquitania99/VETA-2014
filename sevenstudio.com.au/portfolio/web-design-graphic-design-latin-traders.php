...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><!-- InstanceBegin template="/Templates/templateseven.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title>website design penshurst - latintraders</title>
        <!-- InstanceEndEditable -->
...
<div id="navbar" class="fltrt">
                ...
                <div id="centerSection" class="curved"><!-- InstanceBeginEditable name="contenido" -->                    <div id="portframe" class="fltlft">
                      <div id="slider" class="nivoSlider">
                        <img src="../images/portfolio/Latin-Traders/latintraders1.jpg" alt="graphic design - logo" />
					    <img src="../images/portfolio/Latin-Traders/latintraders2.jpg" alt="Graphic Design Sydney South - Business Cards" />
                        <img src="../images/portfolio/Latin-Traders/latintraders3.jpg" alt="Graphic Design Sydney South - Business Cards" /></div>
                    <script type="text/javascript">
