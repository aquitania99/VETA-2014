...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><!-- InstanceBegin template="/Templates/templateseven.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <link rel="stylesheet" href="../css/nivo-slider-portfolio.css" type="text/css" media="screen" />
        <!-- Slide Show End -->
        <style type="text/css" media="all">
            #navbar .portfolio, .portfolio:hover {
                background:#000;
...
<div id="navbar" class="fltrt">
                    <ul class="nav_ul"><!-- InstanceBeginEditable name="menu" -->
                        ...
                        <li><a href="../portfolio.php" class="curved portfolio">PORTFOLIO</a></li>
                    <li><a href="../contact.php" class="curved">CONTACT</a></li><!-- InstanceEndEditable -->
                    </ul>
            </div>
                <div id="centerSection" class="curved"><!-- InstanceBeginEditable name="contenido" -->                    <div id="portframe" class="fltlft">
                      <div id="slider" class="nivoSlider">
                        <img src="../images/portfolio/VETA/veta1.jpg" alt="graphic design - logo" />
						 <img src="../images/portfolio/VETA/veta2.jpg" alt="Graphic Design Sydney South - Business Cards" />
                         <img src="../images/portfolio/VETA/veta3.jpg" alt="website development - landing page" />
                         <img src="../images/portfolio/VETA/veta4.jpg" alt="website development - landing page" />
                         <img src="../images/portfolio/VETA/veta5.jpg" alt="website development - landing page" /></div>
                    <script type="text/javascript">
                    ...
                    <div class="portfolioTitle">PORTFOLIO</div>
                      <div id="portfolioBlurb" style="height:600px">
                        <p class="titleportfolioname">
                          <b>VETA</b><br />
                  <ul>
                                <li><b>Graphic Design</b></li>
                                <li>Logo Design</li>
                                <li>Business cards and flyer design</li>
								<li>Promotional Banner</li>
								<li>Stickers</li>
								<li>Referral Cards</li>
                                <br />
                                <li><b>Website Design &amp; Development</b></li>
                                <li>website design in English &amp; Spanish</li>
								<li>Subscribers Form</li>
								<li>Testimonials video gallery</li>
								<li>Online advisors via MSN</li> 
								<li>Contact Form</li>
								<br />
								<li><b>E-mail Marketing System</b></li>
								<li>Newsletter</li>
								<li>General notifications and Jobs  </li>
								<li>Visas about to expire notifications</li>
								<li>Seminar Invitations</li>
                            </ul>
                        </p> 
                        <div id="navigation">
						<div id="previous" onClick="window.location='website-and-graphic-design-sydney-Advance-Property-Solutions.php'"></div>
						<span class="back-to-portfolio"><a href="../portfolio.php" title="">Back to Portfolio</a></span>
						<div id="next" onClick="window.location='web-design-greenlight-entertainment-group.php'"></div>
				  </div>
                     </div>
                      <div id="portfoliolinkSM"> <span style="width: 80px; height:25px !important" class="fltlft">
                        <iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.sevenstudio.com.au%2Fportfolio%2Fweb-design-web-development-graphic-design-australia-veta.php&amp;send=false&amp;layout=button_count&amp;width=80&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=25" scrolling="No" frameborder="0" style="border:none; overflow:hidden; width:80px; height:25px;" allowtransparency="true"></iframe>
                        </span> <span style="width: 80px; height:25px !important" class="fltlft"> <a href="https://twitter.com/share" class="twitter-share-button" data-via="7StudioAU" data-lang="en" data-count="none" data-hashtags="7Studio" style="height:25px !important;">Tweet</a>
                        <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
                        </span> <br />
                        <!-- Place this tag where you want the +1 button to render -->
                        <span style="width: 80px; height:25px !important" class="fltlft">
