...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><!-- InstanceBegin template="/Templates/templateseven.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title>website design Sydney - tropical trade ltd</title>
        <!-- InstanceEndEditable -->
...
<div id="navbar" class="fltrt">
                ...
                <div id="centerSection" class="curved"><!-- InstanceBeginEditable name="contenido" -->                    <div id="portframe" class="fltlft">
                      <div id="slider" class="nivoSlider">
                        <img src="../images/portfolio/Tropical-Trade/tropicaltrade1.jpg" alt="graphic design - logo" />
					    <img src="../images/portfolio/Tropical-Trade/tropicaltrade2.jpg" alt="Graphic Design Sydney South - Business Cards" />
                        <img src="../images/portfolio/Tropical-Trade/tropicaltrade3.jpg" alt="Graphic Design Sydney South - Business Cards" /></div>
                    <script type="text/javascript">
                  ...
                  <ul>
                        ...
                        <div id="navigation">
						<div id="previous" onClick="window.location='web-design-graphic-design-latin-traders.php'"></div>
						<span class="back-to-portfolio"><a href="../portfolio.php" title="">Back to Portfolio</a></span>				  </div>
                     </div>
                      <div id="portfoliolinkSM"> <span style="width: 80px; height:25px !important" class="fltlft">
                        <iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.sevenstudio.com.au%2Fportfolio%2Fweb-design-tropical-trader.php&amp;send=false&amp;layout=button_count&amp;width=80&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=25" scrolling="No" frameborder="0" style="border:none; overflow:hidden; width:80px; height:25px;" allowtransparency="true"></iframe>
