...
<div id="navbar" class="fltrt">
                ...
                <div id="centerSection" class="curved"><!-- InstanceBeginEditable name="contenido" -->                    <div id="portframe" class="fltlft">
                      <div id="slider" class="nivoSlider">
                        <img src="../images/portfolio/Greenlight-Entertainment-Group/greengroup1.jpg" alt="graphic design - logo" />
					    <img src="../images/portfolio/Greenlight-Entertainment-Group/greengroup2.jpg" alt="Graphic Design Sydney South - Business Cards" /></div>
                    <script type="text/javascript">
                    ...
                    <div class="portfolioTitle">PORTFOLIO</div>
                      <div id="portfolioBlurb">
                        <p class="titleportfolioname">
                          <b>Greenlight Entertainment Group</b><br />
                  <ul>
                        ...
                        <div id="navigation">
						<div id="previous" onClick="window.location='web-design-web-development-graphic-design-australia-veta.php'"></div>
						<span class="back-to-portfolio"><a href="../portfolio.php" title="">Back to Portfolio</a></span>
						<div id="next" onClick="window.location='web-design-web-development-greenlight-memorabilia.php'"></div>
				  </div> 
                     </div>
                      <div id="portfoliolinkSM"> <span style="width: 80px; height:25px !important" class="fltlft">
                        <iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.sevenstudio.com.au%2Fportfolio%2Fweb-design-greenlight-entertainment-group.php&amp;send=false&amp;layout=button_count&amp;width=80&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=25" scrolling="No" frameborder="0" style="border:none; overflow:hidden; width:80px; height:25px;" allowtransparency="true"></iframe>
