...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><!-- InstanceBegin template="/Templates/templateseven.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title>graphic design penshurst - web development</title>
        <!-- InstanceEndEditable -->
...
<div id="navbar" class="fltrt">
                ...
                <div id="centerSection" class="curved"><!-- InstanceBeginEditable name="contenido" -->                    <div id="portframe" class="fltlft">
                      <div id="slider" class="nivoSlider">
                        <img src="../images/portfolio/estudienaustralia/graphic-design-estudienaustralia-logo.jpg" alt="graphic design - logo" />
                        
               	  <img src="../images/portfolio/estudienaustralia/graphic-design-sydney-estudienaustralia-business-cards.jpg" alt="Graphic Design Sydney South - Business Cards" /><img src="../images/portfolio/estudienaustralia/website-design-penshurst-estudienaustralia-landing-page.jpg" alt="website development - landing page" /></div>
                    <script type="text/javascript">
