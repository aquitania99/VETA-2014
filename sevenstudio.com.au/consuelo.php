...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><!-- InstanceBegin template="/Templates/templateseven.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <link rel="icon" href="avicon.ico" type="image/ico" />
...
<div id="navbar" class="fltrt">
              ...
              <div id="slider" class="nivoSlider">
                        <img src="images/bannarhome1.jpg" alt="Advance Property Solutions" />
                        
                    	<img src="images/bannarhome2.jpg" alt="Web Development Penshurst, Web Design Sydney South" />
                        
                        <img src="images/bannarhome3.jpg" alt="mobile apps, website development" />                </div>
                    <script type="text/javascript">
            ...
            <div id="quoteGirl" onclick="window.location='http://www.sevenstudio.com.au/contact.php'"> </div>
                ...
                <div id="texdestacado">Welcome we are <strong>Seven Studio</strong>, an amazing crew, professional, reliable,  passionate about <strong>Web Design</strong>, <strong>Internet Development</strong>,<strong> e-marketing</strong> and <strong>Social Media</strong>.</div>
            <!-- InstanceEndEditable -->
                <div id="boxmed">
            <div class="middleCol">
              <div class="midTitle">
                ...
                <div class="HP_container">
                  <div class="HP"><img src="images/p1.png" width="150" height="192" /></div>
                  <div class="HP"><img src="images/p2.png" width="150" height="192" /></div>
                  <div class="HP"><img src="images/p3.png" /></div>
                  <div class="HP"><img src="images/p4.png" width="150" height="192" /></div>
                </div>
                <!-- InstanceEndEditable -->
				<!-- InstanceBeginEditable name="recent" --><!-- InstanceEndEditable -->
                </div>
			<!-- InstanceBeginEditable name="banner" -->
            <div class="middleColtw"><table width="190" border="0" align="center" cellpadding="0" cellspacing="3">
  <tr>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="160" align="left" valign="middle">&nbsp;</td>
  </tr>
  <tr>
    <td align="left" valign="middle"><strong>Name</strong></td>
  </tr>
  <tr>
    <td align="left" valign="middle"><input name="textfield" type="text" id="textfield" size="26" /></td>
  </tr>
  <tr>
    <td align="left" valign="middle"><strong>E-mail</strong></td>
  </tr>
  <tr>
    <td align="left" valign="middle"><input name="textfield2" type="text" id="textfield2" size="26" /></td>
  </tr>
  <tr>
