...
<cms:template clonable='1' nested_pages='1' title='Index'>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', "<cms:get_custom_field 'google_acc' masterpage='globals.php' />"]);
...
<table width="820" height="430" border="0" cellspacing="20" cellpadding="0" style="position:absolute; margin:210px 0 0 103px">
  ...
  <td valign="top">
  			...
  			<cms:if "<cms:not_empty banner_1 />" ><div id="slider" style="margin-bottom:20px"><img src="<cms:show banner_1 />" width="580px" height="100px"/>
            
            <cms:if "<cms:not_empty banner_2 />" ><img src="<cms:show banner_2 />" width="580px" height="100px"/></cms:if>
            
            <cms:if "<cms:not_empty banner_3 />" ><img src="<cms:show banner_3 />" width="580px" height="100px"/></cms:if>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:30px">
              <tr>
                ...
                <table width="100%" width="180" border="0" cellspacing="0" cellpadding="0">
                   ...
                   <tr>
                     <td bgcolor="#E5E1DC"><a href="<cms:show tab_1 />"><img src="<cms:show prop_image_1 />" width="100%" height="55px" /></a></td>
                   </tr>
                   </cms:if>  
                </table>
                </td>
                ...
                <table width="100%" width="180" border="0" cellspacing="0" cellpadding="0">
                   ...
                   <tr>
                     <td bgcolor="#E5E1DC"><a href="<cms:show tab_2 />"><img src="<cms:show prop_image_2 />" width="100%" height="55px" /></a></td>
                   </tr>
                   </cms:if>  
                </table>
                </td>
                ...
                <table width="100%" width="180" border="0" cellspacing="0" cellpadding="0">
                   ...
                   <tr>
                     <td bgcolor="#E5E1DC"><a href="<cms:show tab_3 />"><img src="<cms:show prop_image_3 />" width="100%" height="55px" /></a></td>
                   </tr>
                   </cms:if>    
                </table>
                </td>
  ...
  <table width="100%" height="155" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="titleboxe" height="30" bgcolor="#ED174C">LATEST NEWS</td>
          </tr>
          <tr>
            <td bgcolor="#E5E1DC" height="115" style="font-size:9px; padding: 0 10px 10px">
            
            		<cms:pages page_name='news'><cms:excerptHTML count='25' ignore='img'><cms:show paragraph /></cms:excerptHTML>
					<!-- Read More Button -->
...
<cms:else />
   <cms:masquerade 'http://mmmigration.com.au/test/index.php?p=1' />
</cms:if>
