...
<script type="text/JavaScript" src="dev/mmm.js"></script>
<script type="text/JavaScript" src="dev/val_contactForm.js"></script>
<script type="text/JavaScript" src="dev/popWindows.js"></script>
<!-- InstanceEndEditable -->
...
<div class="container">
  ...
  <div class="content">
    <div class="breadcrumbs"><!-- InstanceBeginEditable name="breadcrumbs" -->Home<img src="dev/images/arrows.gif" width="12" height="12" alt="migrating" />Enquiry form<!-- InstanceEndEditable --></div>
    <div class="sidebar">
      <div class="testimonials"><!-- InstanceBeginEditable name="testimonals" -->&quot;I have had no problems along the way and any issues that I have raised have been answered in a timely and very accurate manner.&quot; <img src="dev/images/Great-Barrier-Reef.jpg" alt="About the Australain Immigration Sector" height="123" width="157" /><!-- InstanceEndEditable --></div>
      <div class="social-media"> <p><a href="http://www.facebook.com/pages/MMMigration/159594327402637?v=page_getting_started#!/pages/MMMigration/159594327402637?v=wall"><img src="dev/images/facebook.gif" width="35" height="35" alt="MMMigration Facebook" /></a>        <a href="http://twitter.com/MMMigration"><img src="dev/images/twitter.gif" width="35" height="35" alt="MMMigration Twitter" /></a>
<a href="http://twitter.com/MMMigration"><img src="dev/images/youtube.gif" width="35" height="35" alt="MMMigration YouTube" /></a>
		<a href="http://au.linkedin.com/pub/melanie-macfarlane/17/a14/21b"><img src="dev/images/linkdin.gif" width="35" height="35" alt=" Melanie  Macfarlane LinkdIn, " /></a></p>
      </div>
    </div>
 ...
 <%  if request("process") = "true" then ' THANK the user below%>
	 ...
	 <% else ' show APPLICATION FORM%>
	  <form method="post" action="dev/enquiry.asp?process=true" onsubmit="return validateForm(this);" name="applicationForm">
	    <table width="100%" border="0" cellspacing="5" cellpadding="0">
          ...
          <tr>
            ...
            <td ><!--#include file="dev/includes/select_date.asp" -->             </td>
          </tr>
          <tr>
		...
		<tr>
          ...
          <tr>
            ...
            <td colspan="2"><!--#include file="dev/includes/select_date.asp" -->  </td>
          ...
          <tr>
            <td colspan="2"><table width="100%" border="0" cellspacing="5" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><!--#include file="dev/includes/select_date.asp" --> </td>
                <td valign="top"><!--#include file="dev/includes/select_date.asp" --> </td>
                </tr>
              <tr>
                <td >2</td>
...
(dd/mm/yyyy)</td>
            ...
            <tr>
                  <td ><img src="dev/img/img_pix.gif" alt="" width="100%" height="1" /></td>
            </tr>
            ...
            <td colspan="2"><strong>English Language:</strong><br />              <br /></td>
                ...
                <!--#include file="dev/includes/select_yesno.asp"--></td>
                <tr>
          ...
          <td colspan="2"><label for="medicalconditions">Do you currently suffer from or have you suffered from any significant medical conditions? </label>
                <!--#include file="dev/includes/select_yesno.asp"--></td></tr>
    ...
    <div class="navigation"><br />
      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="800" height="100" id="FlashID" title="mmmigration">
        <param name="movie" value="dev/swf/navigation.swf" />
        ...
        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="dev/swf/navigation.swf" width="800" height="100">
          <!--<![endif]-->
          <param name="quality" value="high" />
          <param name="wmode" value="opaque" />
          <param name="swfversion" value="8.0.35.0" />
