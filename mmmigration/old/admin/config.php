<?php
   ...
   */
   ...
   define( 'K_DB_NAME', 'mmmdatabase_mmmigration_com_au' );
   // 5.
   // Database username
   define( 'K_DB_USER', 'mymmmd1001' );
   // 6.
   // Database password 
   define( 'K_DB_PASSWORD', 'm3mMUrDN' );
   // 7.
   // MySQL hostname (it will usually be 'localhost' )
   define( 'K_DB_HOST', 'mysql-5.mmmigration.com.au' );
   // 7b.
   ...
   define( 'K_EMAIL_TO', 'info@mmmigration.com.au' );

   // 14.
   // Will be used as the sender of messages delivered by contact forms to the address above.
   define( 'K_EMAIL_FROM', 'contact@mmmigration.com.au' );
