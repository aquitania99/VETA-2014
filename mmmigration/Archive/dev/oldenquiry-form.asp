...
<div class="container">
  ...
  <div class="content">
    <div class="breadcrumbs"><!-- InstanceBeginEditable name="breadcrumbs" -->Home<img src="images/arrows.gif" width="12" height="12" alt="migrating" />Enquiry form<!-- InstanceEndEditable --></div>
    <div class="sidebar">
      <div class="testimonials"><!-- InstanceBeginEditable name="testimonals" -->&quot;I have had no problems along the way and any issues that I have raised have been answered in a timely and very accurate manner.&quot; <img src="images/Great-Barrier-Reef.jpg" alt="About the Australain Immigration Sector" height="123" width="157" /><!-- InstanceEndEditable --></div>
...
(dd/mm/yyyy)</td>
    ...
    <div class="navigation"><br />
      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="800" height="100" id="FlashID" title="mmmigration">
        ...
        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="swf/navigation.swf" width="800" height="100">
          <!--<![endif]-->
          <param name="quality" value="high" />
          <param name="wmode" value="opaque" />
          <param name="swfversion" value="8.0.35.0" />
