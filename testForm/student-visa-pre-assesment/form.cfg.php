...
"rules":{"title":{"label":" T&iacute;tulo","fieldtype":"dropdown","values":["Seleciona Uno","Mr.","Mrs.","Srta.","Dr.","Prof."]},"name":{"label":"Nombre","fieldtype":"text","required":true},"lastname":{"label":"Apellido","fieldtype":"text","required":true},"email":{"label":"Correo Electr&oacute;nico","fieldtype":"text","required":true},"phone":{"label":"Tel&eacute;fono","fieldtype":"text","required":true},"dob":{"date":true,"label":"Fecha de Nacimiento","fieldtype":"date","date_config":{"minDate":0,"maxDate":1361232000,"dateFormat":"DATE_CUSTOM_1"},"required":true},"countrypassport":{"label":"Por favor selecciona el Pa&iacute;s de tu Pasaporte","fieldtype":"dropdown","required":true,"values":["","Afghanistan","Albania","Algeria","American Samoa","Andorra","Angola","Anguilla","Antarctica","Antigua And Barbuda","Argentina","Armenia","Aruba","Australia","Austria","Azerbaijan","Bahamas","Bahrain","Bangladesh","Barbados","Belarus","Belgium","Belize","Benin","Bermuda","Bhutan","Bolivia","Bosnia And Herzegovina","Botswana","Bouvet Island","Brazil","British Indian Ocean Territory","Brunei","Bulgaria","Burkina Faso","Burundi","Cambodia","Cameroon","Canada","Cape Verde","Cayman Islands","Central African Republic","Chad","Chile","China","Christmas Island","Cocos (Keeling) Islands","Colombia","Comoros","Congo","Cook Islands","Costa Rica","Cote D'Ivorie (Ivory Coast)","Croatia (Hrvatska)","Cuba","Cyprus","Czech Republic","Democratic Republic Of Congo (Zaire)","Denmark","Djibouti","Dominica","Dominican Republic","East Timor","Ecuador","Egypt","El Salvador","Equatorial Guinea","Eritrea","Estonia","Ethiopia","Falkland Islands (Malvinas)","Faroe Islands","Fiji","Finland","France","France, Metropolitan","French Guinea","French Polynesia","French Southern Territories","Gabon","Gambia","Georgia","Germany","Ghana","Gibraltar","Greece","Greenland","Grenada","Guadeloupe","Guam","Guatemala","Guinea","Guinea-Bissau","Guyana","Haiti","Heard And McDonald Islands","Honduras","Hong Kong","Hungary","Iceland","India","Indonesia","Iran","Iraq","Ireland","Israel","Italy","Jamaica","Japan","Jordan","Kazakhstan","Kenya","Kiribati","Kosovo","Kuwait","Kyrgyzstan","Laos","Latvia","Lebanon","Lesotho","Liberia","Libya","Liechtenstein","Lithuania","Luxembourg","Macau","Macedonia","Madagascar","Malawi","Malaysia","Maldives","Mali","Malta","Marshall Islands","Martinique","Mauritania","Mauritius","Mayotte","Mexico","Micronesia","Moldova","Monaco","Mongolia","Montserrat","Morocco","Mozambique","Myanmar (Burma)","Namibia","Nauru","Nepal","Netherlands","Netherlands Antilles","New Caledonia","New Zealand","Nicaragua","Niger","Nigeria","Niue","Norfolk Island","North Korea","Northern Mariana Islands","Norway","Oman","Pakistan","Palau","Panama","Papua New Guinea","Paraguay","Peru","Philippines","Pitcairn","Poland","Portugal","Puerto Rico","Qatar","Reunion","Romania","Russia","Rwanda","Saint Helena","Saint Kitts And Nevis","Saint Lucia","Saint Pierre And Miquelon","Saint Vincent And The Grenadines","San Marino","Sao Tome And Principe","Saudi Arabia","Senegal","Seychelles","Sierra Leone","Singapore","Slovak Republic","Slovenia","Solomon Islands","Somalia","South Africa","South Georgia And South Sandwich Islands","South Korea","Spain","Sri Lanka","Sudan","Suriname","Svalbard And Jan Mayen","Swaziland","Sweden","Switzerland","Syria","Taiwan","Tajikistan","Tanzania","Thailand","Togo","Tokelau","Tonga","Trinidad And Tobago","Tunisia","Turkey","Turkmenistan","Turks And Caicos Islands","Tuvalu","Uganda","Ukraine","United Arab Emirates","United Kingdom","United States","United States Minor Outlying Islands","Uruguay","Uzbekistan","Vanuatu","Vatican City (Holy See)","Venezuela","Vietnam","Virgin Islands (British)","Virgin Islands (US)","Wallis And Futuna Islands","Western Sahara","Western Samoa","Yemen","Yugoslavia","Zambia","Zimbabwe"]},"studytype":{"label":"Que estudios deseas tomar en Australia?","fieldtype":"listbox","required":true,"values":["Primaria - Secundaria / Primary - Secondary","Vocacional - Tecnico / Vocational - Technical","Universidad Pregrado","Universidad Postgrado","Universidad Master o Doctorado","Curso de Ingles"]},"studyfunds":{"label":"Tienes los fondos suficientes para cubrir sus estudios en Australia?","required":true,"fieldtype":"radiogroup","values":["Si","No"]},"livingcostsfunds":{"label":"Tienes los fondos sufientes para tus gastos personales y extras durante tu estadia en Australia?","required":true,"fieldtype":"radiogroup","values":["Si","No"]},"studyduration":{"label":"Por cuanto tiempo planeas estar en Australia para realizar tus estudios?","fieldtype":"dropdown","required":true,"values":["","Menos de 3 meses","3 - 12 meses","Mas de 12 meses"]},"accompaniedbyfamily":{"label":"Te acompa&ntilde;ar&aacute; algun miembro de tu Familia en tu viaje a Australia?","required":true,"fieldtype":"radiogroup","values":["Si","No"]}},
"payment_rules":{"title":{},"countrypassport":{},"studytype":{},"studyfunds":{},"livingcostsfunds":{},"studyduration":{},"accompaniedbyfamily":{}},
"conditional_rules":{"countrypassport":{"element":{"name":"dob","operator":"is_not","value":""}},"studytype":{"element":{"name":"countrypassport","operator":"is_not","value":""}},"studyfunds":{"element":{"name":"countrypassport","operator":"is_not","value":""}},"livingcostsfunds":{"element":{"name":"countrypassport","operator":"is_not","value":""}},"studyduration":{"element":{"name":"countrypassport","operator":"is_not","value":""}},"accompaniedbyfamily":{"element":{"name":"studyduration","operator":"is_not","value":""}}},
